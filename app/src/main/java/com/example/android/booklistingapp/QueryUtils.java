    ...
    private static List<Book> extractFeatureFromJson(String bookJSON) {
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                // key called "volumeInfo", which represents a list of the basic information
                // for that book.
                ...
                // Create a StringBuilder to Display Authors if they are more than 1
                // I saw this pattern in the forum from a fellow student
                StringBuilder authors = new StringBuilder();
                if (volumeInfo.has("authors")) {
                    // Extract the values from the JSONArray key called "authors"
                    JSONArray authorsArray = volumeInfo.getJSONArray("authors");
                    int count = authorsArray.length();

                    // For each author in the JSONArray, display (append)
                ...
                // Create a new {@link Book} object with the title, authors, subtitle, date,
                // and url from the JSON response.
                Book book = new Book(title, authors.toString(), date, url);
